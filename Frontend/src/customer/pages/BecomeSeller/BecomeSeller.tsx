    ...
    <div className="grid md:gap-10 grid-cols-3 min-h-screen ">
      ...
      <section className=" hidden md:col-span-1 md:flex  lg:col-span-2  justify-center items-center">
        <div className="lg:w-[80%] px-5 space-y-10">
          <div className="rounded-md space-y-2 font-bold text-center">
            <p className=" text-2xl">Join the Farming Revolution</p>
            <p className="text-lg text-orange-500"> Boost Your Sales Today</p>
          </div>

          <img className="" src={"https://static.vecteezy.com/system/resources/thumbnails/030/907/930/small_2x/a-mature-farmer-working-in-the-field-at-sunrise-harvesting-crops-generated-by-ai-photo.jpg"} alt="" />
          {/* <div>
                <p className=" logo absolute p-6 rounded-t-full text-white text-center top-0 left-16 right-11 bg-orange-500">Crop Market</p>
            </div> */}
        </div>
      </section>
