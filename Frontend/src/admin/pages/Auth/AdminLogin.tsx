...
// max-w-md h-[65vh] rounded-md  shadow-lg 
//flex justify-center h-[90vh] items-center

    return (
        <div className=''>
            <div className='max-w-md shadow-lg rounded-md h-[80vh]'>
            <img className='w-full rounded-t-md pb-5'
            src="https://www.allthingssupplychain.com/wp-content/uploads/2022/01/GettyImages-1292347633-21.jpg" alt="" />
            <h1 className=' text-center font-bold text-2xl text-primary-color'>Admin Login</h1>
            <form className=" mt-8 px-10 space-y-5">
                        ...
                        {isTimerActive ? (
                            ...
                            <>
                                ...
                                <span
                                    ...
                                    className="text-orange-500 cursor-pointer hover:text-orange-600 font-semibold"
                                >
                                    Resend OTP
                                </span>
                            </>
